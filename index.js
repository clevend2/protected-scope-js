 ...
 */
import { initProtectedScopeClass } from './protected-scope-class';
import {
  getProtectedAccessor,
  setProtectedAccessor,
} from './protected-accessor';

function $_(classInstance) {
  return (
    getProtectedAccessor(classInstance) || setProtectedAccessor(classInstance)
  );
}

$_.declare = (Class) => {
  initProtectedScopeClass(Class);
